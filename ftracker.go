...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	squareSpeed := averageSpeed * averageSpeed //возводим в квадрат
	heightCM := height / cmInM

	calories := ((walkingCaloriesWeightMultiplier*weight + (squareSpeed/heightCM)*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return calories
}
